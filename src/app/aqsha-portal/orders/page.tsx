...
export default function AdminOrders() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Advanced Filters */}
      <div className="bg-white p-5 rounded-2xl shadow-lg shadow-primary/5 border border-primary/10 flex flex-col md:flex-row gap-4 items-center justify-between font-heading">
        <div className="relative w-full md:max-w-md">
          ...
          <input
            ...
            className="block w-full pl-11 pr-3 py-3 border border-primary/20 rounded-xl bg-white text-primary placeholder-primary/40 font-medium focus:outline-none focus:ring-2 focus:ring-accent sm:text-sm transition-all"
        ...
        <div className="flex flex-wrap gap-3 w-full md:w-auto">
          <div className="flex-1 md:flex-none">
            ...
            <select
              ...
              className="block w-full pl-3 pr-10 py-2.5 text-xs text-primary font-bold border-primary/20 focus:outline-none focus:ring-accent sm:text-xs rounded-xl border bg-white cursor-pointer"
            >
      ...
      {loading ? (
        ...
        <div className="text-center py-20 bg-white rounded-2xl border border-primary/10 font-heading">
          <p className="text-primary/50 font-medium text-lg">No orders match the selected search filters.</p>
        </div>
      ) : (
        <div className="space-y-4 font-heading">
          {/* Desktop Table View */}
          <div className="hidden md:block bg-white shadow-lg shadow-primary/5 rounded-2xl border border-primary/10 overflow-hidden w-full max-w-full">
                    ...
                    return (
                      <tr key={orderId} className="hover:bg-cream/30 transition-colors">
                        ...
                        <td className="px-6 py-5 whitespace-nowrap text-sm text-primary">
                          ...
                          {customerEmail && <div className="text-[10px] text-primary/50">{customerEmail}</div>}
                        </td>
                        ...
                        <td className="px-6 py-5 whitespace-nowrap text-right text-xs">
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-primary text-white rounded-xl text-xs font-bold uppercase tracking-wider hover:bg-black transition-colors"
                          >
                            <Eye size={12} />
                            <span>Invoice</span>
                          </button>
            ...
            {currentOrders.map((order) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Actions Row */}
                  <div className="border-t border-primary/5 pt-3 flex items-center justify-end">
                    <button
                      type="button"
                      onClick={() => setSelectedOrder(order)}
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-primary text-white rounded-xl text-xs font-bold uppercase tracking-wider hover:bg-black transition-colors"
          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-between gap-4 px-6 py-5 bg-surface/20 border-t border-primary/10">
              <button
                type="button"
                onClick={() => setCurrentPage((prev) => Math.max(prev - 1, 1))}
                disabled={currentPage === 1}
                className="px-4 py-2 border border-primary/15 rounded-xl text-xs font-bold uppercase tracking-wider text-primary hover:bg-surface transition-colors disabled:opacity-40"
              >
                Previous
              </button>
      ...
      {selectedOrder && (
        <div className="fixed inset-0 bg-primary/40 backdrop-blur-sm flex items-center justify-center z-[150] p-4 animate-in fade-in duration-300">
          <div className="bg-surface rounded-[32px] border border-primary/10 p-6 md:p-8 max-w-2xl w-full shadow-2xl relative animate-in zoom-in-95 duration-200 flex flex-col max-h-[90vh] overflow-y-auto font-heading">
            ...
            <div className="flex justify-between items-start border-b border-primary/10 pb-4 mb-6">
              <div>
                ...
                <p className="text-xs text-primary/50 mt-0.5 font-medium">Placed on {formatDate(selectedOrder.createdAt)}</p>
              </div>
              <button
            ...
            {selectedOrder.status === 'Cancelled' && (
              <div className="bg-red-50 border border-red-200 rounded-2xl p-4 mb-6 font-heading">
            ...
            {selectedOrder.returnStatus && selectedOrder.returnStatus !== 'None' && (
              <div className={`border rounded-2xl p-4 mb-6 font-heading ${
              ...
              <div className="flex flex-wrap gap-2">
                <div>
                  ...
                  <select
                    ...
                    disabled={updatingId !== null}
                    className="block text-xs font-black uppercase tracking-wider rounded-lg px-2 py-1.5 border border-primary/20 focus:outline-none bg-white text-primary cursor-pointer"
                  >
                    <option value="Pending">Pending</option>
                    <option value="Paid">Paid</option>
                    <option value="Failed">Failed</option>
