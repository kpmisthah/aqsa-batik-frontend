...
export default function AdminUsers() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Filter & Search */}
      <div className="bg-white p-5 rounded-2xl shadow-lg shadow-primary/5 border border-primary/10 flex gap-4 justify-between items-center">
      ...
      {loading ? (
        ...
        <div className="text-center py-20 bg-white rounded-2xl border border-primary/10">
          <p className="text-primary/50 font-medium text-lg">No users yet. Click &quot;Add User&quot; to get started.</p>
        </div>
      ) : (
        <UserTable
          users={userList}
