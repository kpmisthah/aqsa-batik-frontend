        ...
        <form ref={formRef} className="space-y-5 max-h-[60vh] overflow-y-auto pr-2">
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-primary/20 rounded-xl p-3 text-primary focus:ring-2 focus:ring-accent focus:outline-none font-medium file:mr-4 file:py-1 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-bold file:bg-tan file:text-primary hover:file:bg-accent cursor-pointer"
            />
              ...
              {imageItems.map((item, i) => (
                <div key={item.id} className="relative group">
                  ...
                  <div className="absolute inset-0 bg-black/40 rounded-xl opacity-0 group-hover:opacity-100 flex flex-col items-center justify-center transition-opacity gap-1">
                    ...
                    {i !== 0 && (
                        <button type="button" onClick={() => makeThumbnail(i)} className="bg-accent text-primary text-[9px] font-black uppercase px-2 py-0.5 rounded shadow-sm hover:bg-[#F4C430] transition-colors">
                           Make Thumbnail
                        </button>
                    )}
                  </div>
                  ...
                  {i === 0 && (
                    <div className="absolute -bottom-2 -left-2 bg-accent text-primary text-[10px] font-black uppercase px-2 py-0.5 rounded-full shadow-sm border border-primary/10">
                      Thumbnail
                    </div>
                  )}
                </div>
            ...
            <p className="text-xs text-primary/50 mt-2 font-medium">Click to select more images. The first image will be the main thumbnail.</p>
          </div>
          ...
          <div className="flex gap-6 pt-2">
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              <input type="checkbox" name="isBestSeller" value="true" defaultChecked={editingProduct?.isBestSeller} className="w-5 h-5 rounded text-primary focus:ring-accent" />
              <span className="text-sm font-bold text-primary">Best Seller</span>
            </label>
            <label className="flex items-center gap-2 cursor-pointer">
