      ...
      <main className="pt-40 pb-32 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col gap-6 mb-16">
            <span className="text-xs font-bold text-secondary uppercase tracking-[0.4em]">Order Management</span>
            <h1 className="font-heading text-4xl md:text-5xl font-bold leading-tight">Cancellation Policy</h1>
            <div className="h-1 w-20 bg-primary"></div>
          </div>

          <div className="flex flex-col gap-12 text-lg leading-relaxed text-primary/80">
            <section className="flex flex-col gap-8">
              <h2 className="font-heading text-3xl font-bold text-primary">Order Cancellation</h2>
            ...
            <section className="flex flex-col gap-6">
              <h2 className="font-heading text-3xl font-bold text-primary">Refund on Cancellation</h2>
                ...
                <div className="relative z-10 flex flex-col gap-4">
                  ...
                  <div className="flex items-center gap-6 mt-4">
                    <div className="flex flex-col">
                      <span className="text-3xl font-heading font-bold">5–7</span>
