      ...
      <main className="pt-40 pb-32 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col gap-6 mb-16">
            <span className="text-xs font-bold text-secondary uppercase tracking-[0.4em]">Quality Assurance</span>
            <h1 className="font-heading text-4xl md:text-5xl font-bold leading-tight">Refund & Return Policy</h1>
          ...
          <div className="flex flex-col gap-12 text-lg leading-relaxed text-primary/80">
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-green-50 p-10 rounded-3xl border border-green-100 shadow-sm">
                <h2 className="font-heading text-3xl font-bold text-green-900 mb-6 underline decoration-green-300">Eligible Returns</h2>
              ...
              <div className="bg-red-50 p-10 rounded-3xl border border-red-100 shadow-sm">
                <h2 className="font-heading text-3xl font-bold text-red-900 mb-6 underline decoration-red-300">Non-Returnable</h2>
            ...
            <section className="bg-white p-10 rounded-[40px] border border-primary/5 shadow-xl flex flex-col gap-6 items-center text-center">
              ...
              <div className="flex flex-col gap-2">
                <h2 className="font-heading text-3xl font-bold text-primary">Return Window</h2>
                <p className="text-xl font-bold text-secondary">Report within 48 hours of delivery</p>
                <p className="opacity-60 max-w-sm mx-auto">Please inspect your wholesale parcel immediately upon receipt.</p>
              </div>
            </section>

            <section className="flex flex-col gap-6">
              <h2 className="font-heading text-3xl font-bold text-primary">Refund Process</h2>
