        ...
        <div className="bg-[#F5F1EC] min-h-screen font-sans text-[#5A2A1F]">
            ...
            <section className="pt-40 pb-20 px-6">
                <div className="max-w-4xl mx-auto text-center flex flex-col gap-6">
                    ...
                    <h1 className="font-playfair text-6xl md:text-8xl font-bold leading-tight">Where's My Order?</h1>
                ...
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="mt-20 text-center flex flex-col gap-8">
                        ...
                        <div className="flex justify-center gap-8">
                            <a href="https://wa.me/919999999999" className="flex items-center gap-3 text-[#8B3A2B] font-black uppercase tracking-[0.2em] text-xs hover:scale-105 transition-all">
                            ...
                            <a href="tel:+919999999999" className="flex items-center gap-3 text-[#8B3A2B] font-black uppercase tracking-[0.2em] text-xs hover:scale-105 transition-all">
