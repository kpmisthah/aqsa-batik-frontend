        ...
        <div className="bg-cream min-h-screen font-heading text-primary">
            ...
            <section className="pt-40 pb-20 px-6">
                <div className="max-w-4xl mx-auto text-center flex flex-col gap-6">
                    <span className="text-xs font-bold text-secondary uppercase tracking-[0.5em]">Track Shipment</span>
                    <h1 className="font-heading text-4xl md:text-5xl font-bold leading-tight">Where's My Order?</h1>
            ...
            <section className="pb-32 px-6">
                <div className="max-w-3xl mx-auto">
                    <div className="bg-white rounded-[50px] p-10 md:p-16 shadow-2xl border border-primary/5">
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <div className="flex flex-col md:flex-row gap-4">
                                    <input 
                                        ...
                                        className="flex-grow bg-cream border-none rounded-2xl py-6 px-8 text-lg font-bold focus:ring-4 focus:ring-primary/10 transition-all placeholder:opacity-20" 
                                    />
                                    <button type="submit" className="bg-primary text-white px-12 py-6 rounded-2xl font-black text-sm uppercase tracking-[0.3em] hover:scale-[1.02] active:scale-[0.98] transition-all shadow-xl whitespace-nowrap">
                                        Track Now
                                    </button>
                                </div>
                            </div>
                        ...
                        {status === 'result' && (
                            <div className="mt-16 flex flex-col gap-12 animate-in fade-in slide-in-from-bottom-8 duration-700">
                                ...
                                <div className="flex flex-col gap-8">
                                    {[
                                        ...
                                        <div key={i} className="flex gap-8 relative">
                                            {i < 4 && <div className={`absolute left-[19px] top-10 bottom-[-32px] w-0.5 ${step.c ? 'bg-primary' : 'bg-primary/10'}`}></div>}
                                            <div className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 z-10 border-4 border-white shadow-md ${step.c ? 'bg-primary text-white' : 'bg-cream text-primary/20'}`}>
                                            ...
                                            <div className="flex flex-col gap-1 pb-10">
                                                <div className="flex justify-between items-center gap-4">
                                                    <h4 className={`font-bold text-lg ${step.c ? 'text-primary' : 'text-primary/40'}`}>{step.s}</h4>
                                ...
                                <div className="bg-cream p-8 rounded-3xl flex flex-col md:flex-row justify-between items-center gap-6 border border-primary/5">
                                    ...
                                    <a href="#" className="text-xs font-black uppercase tracking-widest text-secondary border-b-2 border-secondary pb-1">View Details on Courier Website</a>
                                </div>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="mt-20 text-center flex flex-col gap-8">
                        ...
                        <div className="flex justify-center gap-8">
                            <a href="https://wa.me/918815373767" className="flex items-center gap-3 text-secondary font-black uppercase tracking-[0.2em] text-xs hover:scale-105 transition-all">
                            ...
                            <a href="tel:+918815373767" className="flex items-center gap-3 text-secondary font-black uppercase tracking-[0.2em] text-xs hover:scale-105 transition-all">
