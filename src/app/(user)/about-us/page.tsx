                    ...
                    <div className="flex flex-col w-full lg:w-1/2 h-full lg:max-h-[600px]">
                        ...
                        <div className="block lg:hidden relative w-full h-[300px] sm:h-[400px] rounded-[24px] overflow-hidden shadow-2xl border-[8px] border-cream mb-8">
                            ...
                            <div className="absolute bottom-4 left-4 right-4 bg-white/90 backdrop-blur-md p-4 rounded-xl border border-primary/5 shadow-xl">
                                <div className="flex flex-col gap-1">
                                    <span className="font-heading text-3xl font-black text-primary">2010</span>
                                    <span className="text-[10px] font-black uppercase tracking-widest text-secondary">The Foundation Year</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col gap-6 overflow-y-auto max-h-[350px] sm:max-h-[450px] lg:max-h-none pr-2 lg:pr-6 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-primary/20 [&::-webkit-scrollbar-thumb]:rounded-full pb-4 md:pb-10 overscroll-contain flex-grow relative">
                            <div className="flex flex-col gap-4 text-sm md:text-base leading-relaxed text-primary/80">
                                ...
                                <ul className="list-none space-y-1 pl-4 md:pl-6 border-l-2 border-secondary/20 font-medium">
                                ...
                                <p className="font-bold text-secondary italic mt-2">That mindset changed everything.</p>
                            </div>
                                ...
                                {[
                                    {
                                        ...
                                        d: (
                                            <div className="flex flex-col gap-3">
                                                ...
                                                <p className="font-bold text-[14px] md:text-base text-secondary italic">That was the real turning point.</p>
                                                <p>
                                                ...
                                                <ul className="list-none space-y-1 pl-4 border-l-2 border-secondary/20 font-medium">
                                    ...
                                    },
                                    {
                                        ...
                                        d: (
                                            <div className="flex flex-col gap-3">
                                                ...
                                                <p className="font-bold text-secondary italic">The internet helped our batik craftsmanship reach beyond local markets.</p>
                                            </div>
                                        )
                                    },
                                    {
                                    ...
                                    },
                                    {
                                        ...
                                        d: (
                                            <div className="flex flex-col gap-3">
                                                ...
                                                <p className="font-bold text-[14px] md:text-base text-secondary italic mt-2">
                    ...
                    <div className="hidden lg:block lg:sticky lg:top-32 relative w-full lg:w-1/2 h-[600px] rounded-[50px] overflow-hidden shadow-2xl border-[15px] border-cream group">
                        ...
                        <div className="absolute bottom-10 left-10 right-10 bg-white/90 backdrop-blur-md p-10 rounded-[40px] border border-primary/5 shadow-xl">
                            <div className="flex flex-col gap-2">
                                <span className="font-heading text-5xl font-black text-primary">2010</span>
                                <span className="text-xs font-black uppercase tracking-widest text-secondary">The Foundation Year</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-24 items-center">
                        ...
                        <div className="order-1 lg:order-2 flex flex-col gap-6 md:gap-10">
                            <div className="flex flex-col gap-2 md:gap-6 text-center lg:text-left">
                                <span className="text-[10px] md:text-xs font-bold text-secondary uppercase tracking-[0.2em] md:tracking-[0.4em]">The Process</span>
                                <h2 className="font-heading text-2xl md:text-4xl font-bold text-primary">Our Whole Fabric Manufacturing Standards</h2>
                            </div>
            ...
            <section className="scroll-animate py-16 md:py-24 bg-cream text-center px-6 border-t border-primary/5">
                <div className="max-w-4xl mx-auto flex flex-col gap-8 md:gap-10">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-5">
                        <a href={WA} target="_blank" rel="noreferrer" className="bg-primary text-white px-6 py-3.5 md:px-8 md:py-4 rounded-xl md:rounded-2xl font-bold text-[11px] md:text-sm hover:scale-105 transition-all shadow-xl uppercase tracking-widest border-2 border-primary">
                            Get Wholesale Catalogue
                        </a>
                        <a href="/fabric-wholesale" className="bg-white text-primary border-2 border-primary px-6 py-3.5 md:px-8 md:py-4 rounded-xl md:rounded-2xl font-bold text-[11px] md:text-sm hover:scale-105 transition-all shadow-md uppercase tracking-widest">
            ...
            <FAQ items={[
                ...
                },
                {
                    ...
                    a: (
                        <div className="flex flex-col gap-2">
                            <p>We focus on:</p>
                            <ul className="list-disc pl-5 space-y-1 text-secondary marker:text-secondary/50 font-semibold">
