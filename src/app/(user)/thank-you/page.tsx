...
function ThankYouContent() {
    ...
    return (
        <div className="bg-[#1C1815] min-h-screen flex items-center justify-center p-4 md:p-8 font-heading">
            <div className="bg-[#E5E0D8] w-full max-w-[1000px] rounded-[32px] relative flex flex-col md:flex-row shadow-2xl overflow-hidden">
                
                {/* Close Button */}
                <Link href="/" className="absolute top-5 right-5 w-10 h-10 rounded-full border border-[#1A1A1A]/20 flex items-center justify-center text-[#1A1A1A] hover:bg-[#1A1A1A] hover:text-white transition-colors z-20 bg-[#E5E0D8]/80 backdrop-blur-sm">
                ...
                <div className="md:w-[45%] relative min-h-[350px] md:min-h-[650px] bg-[#E5E0D8]">
                ...
                {/* Right Side - Content */}
                <div className="md:w-[55%] px-6 py-12 md:py-16 md:px-12 flex flex-col items-center text-center text-[#1A1A1A] z-10 relative">
                    
                    {/* Logo Section */}
                    <div className="flex flex-col items-center gap-1 mb-10">
                        <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2" className="mb-1 text-[#1A1A1A]">
                            <path d="M12 2L2 22h20L12 2z"/>
                            <circle cx="12" cy="14" r="3" fill="currentColor"/>
                            <path d="M12 11v-3"/>
                        </svg>
                        <h2 className="font-heading text-3xl font-bold tracking-[0.2em] text-[#1A1A1A]">AQSHA</h2>
                    ...
                    <div className="flex items-center justify-center gap-4 mb-4">
                        ...
                        <h1 className="font-heading text-3xl md:text-4xl font-bold tracking-tight text-[#1A1A1A]">Thank You!</h1>
                    ...
                    <div className="flex items-center justify-center gap-1.5 mb-6 opacity-30">
                        <div className="w-8 h-px bg-[#1A1A1A]"></div>
                        <div className="w-1.5 h-1.5 rotate-45 border border-[#1A1A1A]"></div>
                        <div className="w-2 h-2 rotate-45 bg-[#1A1A1A]"></div>
                        <div className="w-1.5 h-1.5 rotate-45 border border-[#1A1A1A]"></div>
                        <div className="w-8 h-px bg-[#1A1A1A]"></div>
                    </div>
                    ...
                    {/* Features Box */}
                    <div className="w-full bg-[#F0E5D7] rounded-xl p-5 flex justify-between items-start md:items-center gap-2 mb-10 text-[#1A1A1A] shadow-inner">
                        ...
                        <div className="w-px h-14 bg-[#1A1A1A]/10 hidden md:block"></div>
                        <div className="flex flex-col items-center text-center flex-1">
                            <div className="w-12 h-12 rounded-full bg-[#1A1A1A] text-white flex items-center justify-center mb-3 shadow-md">
                    ...
                    <div className="flex flex-col gap-4 w-full">
                        <a href={WA_LINK} target="_blank" rel="noreferrer" className="w-full bg-[#1A1A1A] hover:bg-[#1A1A1A] text-white rounded-[14px] py-4 flex items-center justify-center gap-3 transition-colors shadow-lg group">
                        ...
                        <Link href="/cotton-cloth" className="w-full bg-transparent border-2 border-[#1A1A1A]/30 hover:border-[#1A1A1A] text-[#1A1A1A] rounded-[14px] py-4 flex items-center justify-center gap-3 transition-colors group">
...
export default function ThankYouPage() {
    return (
        <Suspense fallback={
            <div className="min-h-screen bg-[#1C1815] flex items-center justify-center text-[#E5E0D8] font-bold font-heading">
                Loading...
            </div>
        }>
            <ThankYouContent />
