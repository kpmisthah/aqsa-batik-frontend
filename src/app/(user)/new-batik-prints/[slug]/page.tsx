...
async function getProductBySlug(slug: string) {
    try {
        ...
        const match = products.find((p: any) => {
            ...
            return cat.includes('cloth') || cat.includes('cotton');
        });
            ...
            <section className="py-32 px-6 bg-cream relative overflow-hidden">
                <div className="max-w-7xl mx-auto flex flex-col gap-20 relative z-10">
                    <div className="max-w-3xl">
                        ...
                        <h2 className="font-heading text-4xl md:text-5xl font-bold text-primary mt-4 mb-8">Technical Excellence</h2>
                    </div>

                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        {/* Specs List */}
                        <div className="bg-white p-12 rounded-[50px] shadow-2xl border border-primary/10">
