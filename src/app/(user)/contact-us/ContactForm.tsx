    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 md:gap-6">
            <div className="flex flex-col gap-1.5 md:gap-2">
                <label className="text-[9px] md:text-[10px] font-bold uppercase tracking-[0.2em] text-primary/70 ml-1">Full Name</label>
                <input required name="fullName" type="text" placeholder="John Doe"
                    className="w-full bg-[#FDFBF7] border border-primary/10 rounded-xl px-4 py-3 md:px-5 md:py-4 text-sm md:text-base text-primary font-medium placeholder:text-primary/30 focus:outline-none focus:ring-1 focus:ring-accent focus:border-accent transition-all"
                />
            </div>

            <div className="flex flex-col gap-1.5 md:gap-2">
                <label className="text-[9px] md:text-[10px] font-bold uppercase tracking-[0.2em] text-primary/70 ml-1">Business Phone Number</label>
            ...
            <div className="flex flex-col gap-1.5 md:gap-2">
                <label className="text-[9px] md:text-[10px] font-bold uppercase tracking-[0.2em] text-primary/70 ml-1">Business Name</label>
            ...
            <div className="flex flex-col gap-1.5 md:gap-2">
                <label className="text-[9px] md:text-[10px] font-bold uppercase tracking-[0.2em] text-primary/70 ml-1">Estimated Order Value</label>
                <div className="relative">
                    <select required name="orderValue" defaultValue=""
                        className="w-full bg-[#FDFBF7] border border-primary/10 rounded-xl px-4 py-3 md:px-5 md:py-4 text-sm md:text-base text-primary font-medium appearance-none focus:outline-none focus:ring-1 focus:ring-accent focus:border-accent transition-all cursor-pointer">
                    ...
                    <div className="absolute right-4 md:right-6 top-1/2 -translate-y-1/2 pointer-events-none opacity-50">
                        <svg className="w-4 h-4 md:w-5 md:h-5 text-primary" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m6 9 6 6 6-6" /></svg>
                    </div>
                </div>
            </div>
            ...
            <button
                ...
                className="group relative w-full flex items-center justify-center gap-4 bg-accent text-white px-8 py-4 md:py-4 rounded-full font-bold uppercase tracking-widest text-[11px] md:text-xs hover:bg-accent/90 active:scale-[0.98] transition-all disabled:opacity-50 mt-4 shadow-sm"
            >
