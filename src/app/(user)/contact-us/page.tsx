...
export default function ContactPage() {
    return (
        <div className="bg-[#FDFBF7] min-h-screen font-body text-[#3B1C14] selection:bg-primary selection:text-white">
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-12 flex flex-col items-center">
                        <div className="flex items-center gap-4 mb-4">
                            <span className="w-8 h-[1px] bg-[#8A9A86] hidden md:block"></span>
                            <span className="text-[10px] font-bold text-secondary uppercase tracking-[0.2em]">We're Here To Help</span>
                            <span className="w-8 h-[1px] bg-[#8A9A86] hidden md:block"></span>
                        </div>
                        <h2 className="font-heading text-2xl md:text-4xl font-bold text-[#3B1C14] mb-4">Reach Out To Our Team</h2>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                        <div className="bg-white p-4 md:p-6 rounded-2xl shadow-sm border border-primary/5 flex flex-col items-center text-center hover:shadow-md transition-shadow">
                            <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-cream flex items-center justify-center text-secondary mb-3 md:mb-4">
            ...
            {/* ── FORM SECTION ── */}
            <section id="form" className="py-20 px-6 bg-cream">
                <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
                    <div className="lg:w-1/2">
                        <div className="flex items-center gap-4 mb-6">
                            <span className="w-8 h-[1px] bg-[#8A9A86]"></span>
                            <span className="text-[10px] font-bold text-secondary uppercase tracking-[0.2em]">Get In Touch</span>
                        </div>
                        <h2 className="font-heading text-2xl md:text-3xl lg:text-4xl font-bold text-[#3B1C14] mb-6 leading-[1.2]">
                    ...
                    <div className="lg:w-1/2 w-full">
                        <div className="bg-[#FDFBF7] md:bg-white p-5 md:p-12 rounded-[24px] md:rounded-[50px] shadow-sm md:shadow-[0_30px_100px_rgba(0,0,0,0.05)] border border-primary/5 md:border-white">
                            <ContactForm />
                        </div>
                    </div>
                </div>
            ...
            <section className="py-20 px-6 bg-[#FDFBF7]">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-12 flex flex-col items-center">
                        <div className="flex items-center gap-4 mb-4">
                            <span className="w-8 h-[1px] bg-[#8A9A86] hidden md:block"></span>
                            <span className="text-[10px] font-bold text-secondary uppercase tracking-[0.2em]">Why Choose Aqsha Batik</span>
                            <span className="w-8 h-[1px] bg-[#8A9A86] hidden md:block"></span>
                        </div>
                        <h2 className="font-heading text-2xl md:text-4xl font-bold text-[#3B1C14] mb-4">Trusted By Retailers & Fashion Businesses</h2>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                        {[
                            ...
                            <div key={i} className="bg-white p-4 md:p-6 rounded-2xl shadow-sm border border-primary/5 text-center flex flex-col items-center">
                                <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-[#FDFBF7] flex items-center justify-center text-secondary mb-3 md:mb-4 shadow-sm border border-primary/5">
