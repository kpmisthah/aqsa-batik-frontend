                        ...
                        <form className="flex flex-col gap-8">
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                <div className="relative">
                                    <select
                                        className="w-full bg-white border border-[#5A2A1F]/20 rounded-2xl px-6 py-5 text-[#5A2A1F] font-bold appearance-none focus:outline-none focus:ring-2 focus:ring-[#8B3A2B]/20 transition-all shadow-md"
                                    >
                            ...
                            <button
                                type="submit"
                                className="w-full bg-[#5A2A1F] text-white py-6 rounded-2xl font-black text-xl hover:bg-black hover:scale-[1.02] active:scale-[0.98] transition-all shadow-2xl uppercase tracking-widest flex items-center justify-center gap-4 mt-4"
                            >
