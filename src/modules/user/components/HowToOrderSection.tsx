...
const DEFAULT_SUBTITLE =
    "Shop women's clothing online with ease—from exploring batik suit collections and fabrics to selecting your styles, requesting a quote, and receiving your order across India.";

const STEPS = [
    {
        s: "01",
        t: "Browse Batik Designs",
        d: "Explore our latest women's clothing collections, including batik suits, fresh batik prints, cotton styles, and ready-to-order designs.",
    ...
    },
    {
        s: "02",
        t: "Select Quantity",
        d: "Choose the quantity that fits your needs, whether you're ordering for a boutique, retail store, reseller business, marketplace, or personal wardrobe.",
    ...
    },
    {
        ...
        d: "Share your requirements with our team and get product availability, pricing, and order guidance directly.",
    ...
    },
    {
        ...
        d: "Get clear pricing based on your selected styles, quantities, and order requirements.",
    ...
    },
    {
        s: "05",
        t: "Fast Dispatch",
        d: "Confirm your order and receive your selected collection through trusted delivery partners across India.",
            ...
            <div className="max-w-[1400px] mx-auto flex flex-col gap-6 md:gap-8 relative z-10 w-full">
                    ...
                    <span className="text-overline">{tag}</span>
                        <h2 className="font-heading text-h2 font-medium text-primary">
                            {typeof title === 'string' && title.match(/(women clothing online|online)/i) ? (
                                <>
                                    {title.split(/(women clothing online|online)/i).map((part, i) => 
                                        part.toLowerCase() === 'women clothing online' || part.toLowerCase() === 'online' 
                                            ? <span key={i} className="text-highlight italic">{part}</span> 
                                            : part
                                    )}
                                </>
                            ) : title}
                    ...
                    {steps.map((step, i) => (
                        ...
                        >
                            ...
                            <div className="flex items-center justify-center md:justify-start w-full mb-3 md:mb-5">
                                <span className="text-3xl md:text-4xl lg:text-5xl text-highlight font-heading leading-none font-normal shrink-0 group-hover:scale-110 group-hover:text-primary transition-all duration-300 md:pr-2">
                                    {step.s}
                                </span>
                ...
                <div className="flex justify-center w-full mt-4">
                    <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="btn-primary px-10 py-4.5 w-full md:w-auto"
                    >
