...
export default function AuthModal({ isOpen, onClose, onSuccess }: AuthModalProps) {
  ...
  // Custom OTP Verification & Toast States
  ...
  // Custom Email/Password Sign Up Flow
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
      ...
      >
        ...
        {toast && (
          <div className={`fixed top-6 right-6 z-[250] flex items-center gap-3 px-5 py-4 rounded-2xl shadow-2xl border transition-all duration-300 text-sm font-bold bg-white ${
            toast.type === "success" 
          ...
          <>
            ...
            <form onSubmit={isLogin ? handleEmailSignIn : handleEmailSignUp} className="space-y-4">
              ...
              <div>
                ...
                {/* Password Strength Indicator & Checklist (Only on Sign Up) */}
