        ...
        <section className="scroll-animate py-16 md:py-24 px-4 md:px-6 bg-cream overflow-hidden">
            <div className="max-w-7xl mx-auto flex flex-col gap-12 md:gap-20">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] xl:grid-cols-[1.3fr_0.9fr] gap-12 lg:gap-16 items-center">
                        ...
                        {features.map((feature, i) => (
                            <div key={i} className="flex gap-4 md:gap-5 group">
                                ...
                                <div className="flex flex-col gap-2 w-full">
                                    <h4 className="text-h4 text-primary font-normal group-hover:text-accent transition-colors" dangerouslySetInnerHTML={{ __html: feature.t }} />
                                    <p className="text-body1 text-primary leading-relaxed font-normal max-w-[95%]" dangerouslySetInnerHTML={{ __html: feature.d }} />
                                </div>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="relative h-[450px] md:h-[600px] w-full rounded-tr-[40px] rounded-bl-[40px] overflow-hidden group">
                        <Image 
                            src={imageSrc} 
