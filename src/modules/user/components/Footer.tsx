...
export default function Footer() {
    return (
        <footer id="contact" className="bg-primary text-cream pt-20 pb-28 md:pb-16 px-6 lg:px-16 overflow-hidden">
            <div className="max-w-[1400px] mx-auto relative z-10 flex flex-col gap-16">
                ...
                <div className="flex flex-col lg:flex-row justify-between gap-16 lg:gap-8 pb-16 border-b border-cream/10">
                    ...
                    <div className="lg:w-1/3 flex flex-col gap-8">
                        <img src="/aqsha-logo.png" alt="Aqsha Logo" className="h-16 md:h-20 w-auto object-contain self-start brightness-0 invert opacity-90 transition-opacity" />
                    ...
                    <div className="lg:w-[60%] grid grid-cols-2 md:grid-cols-3 gap-12 lg:gap-16">
                        <div className="flex flex-col gap-6">
                            <span className="text-[10px] uppercase font-bold tracking-[0.2em] text-accent">Quick Links</span>
                        ...
                        <div className="flex flex-col gap-6">
                            <span className="text-[10px] uppercase font-bold tracking-[0.2em] text-accent">Collections</span>
                            <div className="flex flex-col gap-4">
                                {[
                        ...
                        <div className="hidden md:flex flex-col gap-6">
                             <span className="text-[10px] uppercase font-bold tracking-[0.2em] text-accent">Catalogue Access</span>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-6 pb-2">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <a href="https://ufuqtechs.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 group">
                            ...
                            <img src="/partner-logo.jpeg" alt="Partner Logo" className="h-4 w-auto object-contain rounded opacity-40 group-hover:opacity-100 transition-opacity" />
                        </a>
                    </div>
                </div>
            </div>
