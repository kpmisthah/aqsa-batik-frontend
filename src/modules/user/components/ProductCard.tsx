            ...
            <div className="flex flex-col gap-4 px-2 text-center items-center">
                ...
                <div className="flex flex-col gap-3 mt-2">
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="w-full py-4 bg-[#075E54] text-white rounded-xl font-bold text-[13px] uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-[#128C7E] transition-all duration-300 shadow-md"
                    >
