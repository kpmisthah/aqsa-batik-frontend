            ...
            <div className="flex flex-col gap-4 px-2 text-center items-center flex-grow">
                ...
                <div className="flex flex-col gap-2 mt-auto w-full px-1">
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="w-full py-2.5 md:py-4 bg-[#25D366] text-white rounded-lg md:rounded-xl font-bold text-[9px] md:text-[13px] uppercase tracking-[0.1em] md:tracking-widest flex items-center justify-center gap-1.5 hover:bg-[#128C7E] transition-all duration-300 shadow-md"
                    >
