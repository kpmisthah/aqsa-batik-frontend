...
export default function WelcomePopup() {
    ...
    return (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 bg-black/70 backdrop-blur-sm animate-in fade-in duration-300">
            <div className="bg-[#E5E0D8] w-full max-w-[1000px] max-h-[90vh] overflow-y-auto overflow-x-hidden rounded-[24px] md:rounded-[32px] relative flex flex-col md:flex-row shadow-2xl animate-in zoom-in-95 duration-500">

                {/* Close Button */}
                <button onClick={closePopup} className="absolute top-3 right-3 md:top-5 md:right-5 w-10 h-10 rounded-full border border-[#1A1A1A]/20 flex items-center justify-center text-[#1A1A1A] hover:bg-[#1A1A1A] hover:text-white transition-colors z-50 bg-[#E5E0D8]/90 backdrop-blur-sm shadow-sm">
                ...
                <div className="md:w-[45%] relative aspect-[4/5] md:aspect-auto md:min-h-[600px] bg-[#E5E0D8] shrink-0">
                ...
                {/* Right Side - Content */}
                <div className="md:w-[55%] px-4 py-8 md:py-12 md:px-10 flex flex-col items-center text-center text-[#1A1A1A] z-10 relative justify-center">
                    ...
                    <div className="flex flex-col items-center gap-1 mb-6">
                        ...
                        <div className="flex items-center gap-3 text-[8px] uppercase tracking-[0.35em] opacity-80 mt-1">
                            <span className="w-5 h-[1px] bg-[#1A1A1A]"></span>
                            BATIK SUITS
                            <span className="w-5 h-[1px] bg-[#1A1A1A]"></span>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-center gap-3 mb-4">
                        ...
                        <span className="text-[10px] md:text-[11px] font-black uppercase tracking-[0.2em] text-[#1A1A1A]">Welcome To Aqsha Batik Suits</span>
                    ...
                    {/* Title */}
                    <h1 className="font-heading text-2xl md:text-3xl leading-[1.1] font-medium tracking-tight text-[#1A1A1A] mb-5">
                    ...
                    <div className="flex items-center justify-center gap-1.5 mb-5 opacity-30">
                        ...
                        <div className="w-1 h-1 rotate-45 border border-[#1A1A1A]"></div>
                        <div className="w-1.5 h-1.5 rotate-45 bg-[#1A1A1A]"></div>
                        <div className="w-1 h-1 rotate-45 border border-[#1A1A1A]"></div>
                        <div className="w-8 h-px bg-[#1A1A1A]"></div>
                    </div>
                    ...
                    {/* Features Box */}
                    <div className="w-full flex justify-between items-start gap-1 mb-8 text-[#1A1A1A]">
                        {/* 1 */}
                        ...
                        <div className="w-px h-10 bg-[#1A1A1A]/10 mt-2"></div>
                        {/* 2 */}
                        <div className="flex flex-col items-center text-center flex-1">
                            <div className="w-10 h-10 rounded-full bg-[#EADDCD] flex items-center justify-center mb-2 shadow-sm">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 w-full">
                        <a href={WA_LINK} target="_blank" rel="noreferrer" onClick={closePopup} className="flex-1 bg-[#1A1A1A] hover:bg-[#1A1A1A] text-white rounded-xl py-3.5 px-2 flex items-center justify-center gap-2 transition-colors shadow-lg group">
                        ...
                        <Link href="/cotton-cloth" onClick={closePopup} className="flex-1 bg-transparent border-2 border-[#1A1A1A]/30 hover:border-[#1A1A1A] text-[#1A1A1A] rounded-xl py-3.5 px-2 flex items-center justify-center gap-2 transition-colors group">
