            ...
            <div className="bg-surface w-full max-w-[1000px] max-h-[90vh] overflow-y-auto overflow-x-hidden rounded-[24px] md:rounded-[32px] relative flex flex-col md:flex-row shadow-2xl animate-in zoom-in-95 duration-500">
                ...
                <div className="md:w-[55%] px-4 py-8 md:py-12 md:px-10 flex flex-col items-center text-center text-primary z-10 relative justify-center">
                    ...
                    <div className="flex items-center justify-center gap-3 mb-4">
                        ...
                        <span className="text-[10px] md:text-[11px] font-black uppercase tracking-[0.2em] text-primary">Welcome To Aqsha Batik Suits</span>
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="opacity-60 text-secondary">
                            <path d="M12 22C12 22 4 16 4 10C4 6 7.5 3 12 3C16.5 3 20 6 20 10C20 16 12 22 12 22Z" />
                        </svg>
                    </div>
                    ...
                    <div className="w-full flex justify-between items-start gap-1 mb-8 text-primary">
                        ...
                        <div className="w-px h-10 bg-primary/10 mt-2"></div>
                        {/* 2 */}
                        <div className="flex flex-col items-center text-center flex-1">
                            <div className="w-10 h-10 rounded-full bg-tan flex items-center justify-center mb-2 shadow-sm">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 w-full">
                        <a href={WA_LINK} target="_blank" rel="noreferrer" onClick={closePopup} className="flex-1 bg-primary hover:bg-primary text-white rounded-xl py-3.5 px-2 flex items-center justify-center gap-2 transition-colors shadow-lg group">
                        ...
                        <Link href="/batik-prints-womens-clothing" onClick={closePopup} className="flex-1 bg-transparent border-2 border-primary/30 hover:border-primary text-primary rounded-xl py-3.5 px-2 flex items-center justify-center gap-2 transition-colors group">
                    ...
                    <div className="flex items-center justify-center gap-2 mt-6 opacity-80">
                        ...
                        <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor" className="opacity-60 text-secondary">
                            <path d="M12 22C12 22 4 16 4 10C4 6 7.5 3 12 3C16.5 3 20 6 20 10C20 16 12 22 12 22Z" />
                        </svg>
                    </div>
                </div>
